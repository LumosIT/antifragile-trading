        ...
        <form id="my_form" action="{{ isset($promocode) ? route('admin.api.promocodes.edit', $promocode->id) : route('admin.api.promocodes.create') }}" class="card" method="post" autocomplete="off">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-4">
                            <label class="form-label fs-14 text-dark">Код</label>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-4">
                            <label class="form-label fs-14 text-dark">Скидка</label>
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <select name="type" class="form-select flex-grow-1" required>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-4">
                            <label class="form-label fs-14 text-dark">Тарифы</label>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-4">
                            <label class="form-label fs-14 text-dark">Максимально использований</label>
                            <div class="input-group">
                                <div class="input-group-text"><i class="ri-sort-asc"></i></div>
                                <input type="text" class="form-control border-dashed js-mask-int" required name="max_uses" value="{{ isset($promocode) ? $promocode->max_uses : 1 }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-4">
                            <label class="form-label fs-14 text-dark">Действителен до</label>
                            <div class="input-group">
                                <div class="input-group-text"><i class="ri-calendar-2-line"></i></div>
                                <input type="text" class="form-control js-date-picker" placeholder="Выбрать" value="{{ isset($promocode) ? $promocode->expired_at->format('d.m.Y') : now()->addWeek()->format('d.m.Y') }}" name="expired_at">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group mb-4">
                            <label class="form-label fs-14 text-dark">Бонус подписки</label>
                            <div class="d-flex gap-2 flex-wrap">
                                <div class="input-group flex-grow-1">
                                    <div class="input-group-text"><i class="ri-time-line"></i></div>
                                    <input type="text" class="form-control border-dashed js-int-mask" required name="bonus_duration" value="{{ isset($promocode) ? $promocode->bonus_duration : 0 }}">
                                </div>
                                <select class="form-select flex-grow-1" name="bonus_period" required>
                                    @php($periods = [
            ...
            <div class="card-footer d-flex justify-content-end">
                <button type="submit" class="btn btn-primary label-btn">
                    @isset($promocode)
                        <i class="ri-save-2-fill label-btn-icon me-2"></i> Сохранить
                    @else
                        <i class="ri-add-line label-btn-icon me-2"></i> Создать промокод
                    @endisset
